...
modelo_TV=UsoTV~.
# Crear clasificacion
clasificacion_TV=kknn(formula=modelo, entrenamiento, prueba, na.action=na.omit(), k=2)
...
modelo_RRSS=UsoRRSS~.
# Crear clasificacion
clasificacion_RRSS=kknn(formula=modelo, entrenamiento, prueba, na.action=na.omit(), k=2)
