...
plotcluster(numericos[muestra,], agrupacion_jerarquica[muestra])
plotcluster(binarios[muestra,], agrupacion_jerarquica[muestra])
...
cluster.stats(distancia_ponderada, agrupacion_jerarquica)
